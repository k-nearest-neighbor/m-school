                ...
                <div className="flex flex-col w-full p-4">
                  ...
                  <div className=" w-full pt-4">
                    ...
                    <dd className="py-1 w-full flex whitespace-nowrap ">
                      <Link href="https://discord.com/users/993424051949293608" className="flex whitespace-nowrap text-sky-500" >
                    ...
                    <dd className="py-1 w-full flex whitespace-nowrap ">
                      <Link href="https://discord.com/users/993424051949293608" className="flex whitespace-nowrap text-sky-500" >
                        {/* <GitHubIcon className="h-3"></GitHubIcon> */}
                    ...
                    <dd className="py-1 w-full flex whitespace-nowrap ">
                      <Link href="https://discord.com/users/993424051949293608" className="flex whitespace-nowrap text-sky-500" >
                        {/* <DiscordIcon className="h-4"></DiscordIcon> */}
                    ...
                    <dd className="py-1 w-full flex whitespace-nowrap ">
                      ...
                      <Link href="mailto:des@ai-breakout.com" className="flex whitespace-nowrap text-sky-500" >
